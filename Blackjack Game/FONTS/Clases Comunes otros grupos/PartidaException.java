...
*
* Objetivo de la clase: Lanza excepciones de Partida.
* Clases utilizadas: Exception.
*/
public class PartidaException extends java.lang.Exception {
  /** Definición de los atributos */
    ...
    public PartidaException(String mens, String atr, String clase) {
